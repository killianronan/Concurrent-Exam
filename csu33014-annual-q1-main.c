...
float * new_random_float_array(int size, int is_positive) {
  int range = 256;
...
void test_routine_0() {
  ...
  routine_0(out_correct, b, c);
  vectorized_0(out_vectorized, b, c);
...
void test_routine_1() {
  ...
  out_vectorized = vectorized_1(a, b, size);
  out_correct = routine_1(a, b, size);
...
void test_routine_2() {
  ...
  routine_2(out_correct, b, size);
  vectorized_2(out_vectorized, b, size);
...
void test_routine_3() {
  ...
  routine_3(out_correct, b, size);
  vectorized_3(out_vectorized, b, size);
...
void test_routine_4() {
  ...
  routine_4(out_correct, b, c);
  vectorized_4(out_vectorized, b, c);
